...
SELECT
    ...
    END AS `type`,
    CASE
        WHEN `pd`.`type` = 'service' THEN GROUP_CONCAT(DISTINCT json_unquote(json_extract(`ess`.`title`, '$.fr')))
