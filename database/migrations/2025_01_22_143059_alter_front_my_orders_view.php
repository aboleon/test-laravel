...
LEFT JOIN pec_distribution pd ON o.id = pd.order_id  -- Join with pec_distribution table
GROUP BY o.id  -- Group by order ID to aggregate pec values
UNION ALL
SELECT
    'refund' AS `type`,
    ...
    0 AS `total_pec`,  -- Keep this as 0 for refunds,
    0 AS `total_pec_net`,
    0 AS `total_pec_vat`,
