...
return new class extends Migration
{
    ...
    {
        Schema::create('order_cart_grant_deposit', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('event_deposit_id')->constrained()->restrictOnDelete();
            ...
            $table->foreign('event_contact_id', 'ocgpf_beneficiary_contact_fk')->references('id')->on('events_contacts')->restrictOnDelete();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('order_cart_grant_deposit');
    }
};
