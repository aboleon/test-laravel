...
GROUP BY ec.id, event_id, u.id, u.first_name, u.last_name, u.email, domain, participation, ap.company_name, aa.locality, country, fonction, ec.created_at, participation_type_group_display, participation_type;
");
    }
