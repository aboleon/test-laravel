...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::table('event_program_sessions', function (Blueprint $table) {
            if (true === Schema::hasColumn('event_program_sessions', 'group_id')) {
                $table->dropForeign(['group_id']);
                $table->dropColumn('group_id');
            }
            if (false === Schema::hasColumn('event_program_sessions', 'sponsor_id')) {
    ...
    {
        Schema::table('event_program_sessions', function (Blueprint $table) {
            if (Schema::hasColumn('event_program_sessions', 'sponsor_id')) {
