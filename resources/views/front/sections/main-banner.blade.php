        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                ...
                <h1 class="mb-0 display-6">
                    Elevating Events to
                    <span class="position-relative">Extraordinary
                        <!-- SVG START -->
                ...
                <!-- Content -->
                <p class="my-4 lead">Elevate your event experience - Divine Id awaits to unlock the potential of your next gathering.</p>

                <!-- Info -->
                <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
                    <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>Engage with Experts</li>
                    <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>Gain Professional Recognition</li>
                    <li class="list-inline-item"> <i class="bi bi-patch-check-fill h6 me-1"></i>Join Our Community</li>
                </ul>
            ...
            <div class="col-lg-7 col-xl-6 text-center position-relative">
                ...
                <div class="p-3 bg-blur border border-light shadow rounded-4 position-absolute bottom-0 start-0 z-index-9 d-none d-xl-block mb-5 ms-5">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-start ms-3">
                            <h6 class="mb-0 text-white">Divine Id <span class="ms-4"><i class="fas fa-check-circle text-success"></i></span></h6>
                            <p class="mb-0 small text-white">Global Event Specialists</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="position-relative">
                    <img src="{{asset("front/bstheme/images/element/f-orator.png")}}" alt="">
                </div>
            </div>
            <!-- Right content END -->
        </div>
