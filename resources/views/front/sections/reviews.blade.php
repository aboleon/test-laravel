    ...
    <div class="container">
        <div class="row g-4 g-lg-5 align-items-center">
                        ...
                        <div class="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                            ...
                            <div class="avatar avatar-xl mb-3">
                                <img class="avatar-img rounded-circle"
                                     src="{{asset("front/bstheme/images/avatar/01.jpg")}}"
                                     alt="avatar">
                            </div>
                            <!-- Content -->
                            <blockquote>
                                <p>
                                    ...
                                    Divine Id's platform made it so easy to find and register
                                    for medical conferences. The seamless experience and
                                    exceptional organization have made every event memorable.
                                    Highly recommend for healthcare professionals looking to
                            ...
                            <!-- Info -->
                            <h6 class="mb-0">Dr. Carolyn Ortiz, Pediatric Surgeon</h6>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5 mt-5 mt-md-0 d-none d-md-block">
                        <div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="avatar avatar-sm">
                                    <img class="avatar-img rounded-1"
                                         src="{{asset("front/bstheme/images/avatar/09.jpg")}}"
                                         alt="avatar">
                                </div>
                                <!-- Info -->
                                <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="avatar avatar-sm">
                                    <img class="avatar-img rounded-1"
                                         src="{{asset("front/bstheme/images/avatar/04.jpg")}}"
                                         alt="avatar">
                                </div>
                                <!-- Info -->
                                <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm">
                                    <img class="avatar-img rounded-1"
                                         src="{{asset("front/bstheme/images/avatar/02.jpg")}}"
                                         alt="avatar">
                                </div>
                                <!-- Info -->
                                <div class="ms-2">
                ...
                <div class="row mt-5 mt-xl-0">
                    ...
                    <div class="col-md-5 mt-n6 mb-0 mb-md-5">
                        <div class="bg-body shadow text-center p-4 rounded-3">
                            ...
                            <div class="avatar avatar-xl mb-3">
                                <img class="avatar-img rounded-circle"
                                     src="{{asset("front/bstheme/images/avatar/03.jpg")}}"
                                     alt="avatar">
                            </div>
                            <!-- Content -->
                            <blockquote>
                                <p>
                                    <span class="me-1 small"><i class="fas fa-quote-left"></i></span>
                                    As a speaker, Divine Id's attention to detail and audience
                                    engagement tools helped me deliver my presentation
                                    effectively to a global audience. The feedback and
                                    interaction were incredibly valuable.
                                    <span class="ms-1 small"><i class="fas fa-quote-right"></i></span>
                                </p>
                            </blockquote>
                            <!-- Rating -->
                            ...
                            <!-- Info -->
                            <h6 class="mb-0">Prof. Dennis Barrett, Keynote Speaker</h6>
                        </div>
                    </div>
                </div> <!-- Row END -->
            </div>
            <div class="col-xl-5 order-1 text-center text-xl-start">
                <!-- Title -->
                <h2 class="fs-1">Valued Insights from Our Community</h2>
                <p>Hear from the professionals, speakers, and sponsors who've experienced the
                    Divine Id difference.</p>
                <a href="#" class="btn btn-primary mb-0">Read Testimonials</a>
            </div>
        </div> <!-- Row END -->
    </div>
</section>
