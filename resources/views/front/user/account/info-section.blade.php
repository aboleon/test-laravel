@php
    ...
    if($registrationType){
        ...
        if($eventContact){
            $participationGroup = $participationType->group;
        }
    }
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    >
                        <option value="">{{ __('mfw.select_option') }}</option>
                        @foreach($domains as $domain_id => $domain_name)
                            <option
                                value="{{ $domain_id }}"{{ $profile?->domain_id == $domain_id ? ' selected' : ''}}>{{ $domain_name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="row mb-3">
                <label for="select_title"
                       class="col-md-2 col-form-label text-start">{{ __("front/user/account.labels.title") }}</label>
                <div class="col-md-4">
                    <x-select-dictionary
                        key="titles"
                        name="title_id"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <livewire:common.autocomplete
                        ...
                        :initial-value="old('establishment_id', $profile?->establishment_id)"/>
                </div>
            </div>
